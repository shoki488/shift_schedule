...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<parser>.freeze, [">= 3.1.0.0".freeze])
  ...
  s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.19.1".freeze, "< 2.0".freeze])
  s.add_runtime_dependency(%q<ruby-progressbar>.freeze, ["~> 1.7".freeze])
  s.add_runtime_dependency(%q<unicode-display_width>.freeze, [">= 1.4.0".freeze, "< 3.0".freeze])
  s.add_development_dependency(%q<bundler>.freeze, [">= 1.15.0".freeze, "< 3.0".freeze])
end
