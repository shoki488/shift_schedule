...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rubocop>.freeze, ["~> 1.32.0".freeze])
  s.add_runtime_dependency(%q<rubocop-performance>.freeze, ["~> 1.10.2".freeze])
  s.add_runtime_dependency(%q<rubocop-rails>.freeze, ["~> 2.9.1".freeze])
  s.add_runtime_dependency(%q<rubocop-rspec>.freeze, ["~> 2.0.0".freeze])
